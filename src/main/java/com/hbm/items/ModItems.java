...
public class ModItems {
	...
	public static Item stick_dynamite_base;
	...
	{			
		...
		syringe_antidote = new ItemSyringe().setUnlocalizedName("syringe_antidote").setFull3D().setCreativeTab(MainRegistry.consumableTab).setTextureName(RefStrings.MODID + ":syringe_antidote").setMaxStackSize(16);
		syringe_poison = new ItemSyringe().setUnlocalizedName("syringe_poison").setFull3D().setCreativeTab(MainRegistry.consumableTab).setTextureName(RefStrings.MODID + ":syringe_poison").setMaxStackSize(16);
		syringe_awesome = new ItemSyringe().setUnlocalizedName("syringe_awesome").setFull3D().setCreativeTab(MainRegistry.consumableTab).setTextureName(RefStrings.MODID + ":syringe_awesome").setMaxStackSize(16);
		...
		insert_kevlar = new ItemModInsert(500, 0.85F, 1F, 1F, 0.9F).setUnlocalizedName("insert_kevlar").setTextureName(RefStrings.MODID + ":insert_kevlar");
		insert_steel = new ItemModInsert(500, 0.8F, 1F, 1F, 0.8F).setUnlocalizedName("insert_steel").setTextureName(RefStrings.MODID + ":insert_steel");
		insert_du = new ItemModInsert(500, 0.65F, 1F, 1F, 0.6F).setUnlocalizedName("insert_du").setTextureName(RefStrings.MODID + ":insert_du");

		insert_sapi = new ItemModInsert(500, 0.8F, 1F, 1F, 0.9F).setUnlocalizedName("insert_sapi").setTextureName(RefStrings.MODID + ":insert_sapi");
		insert_esapi = new ItemModInsert(500, 0.7F, 1F, 1F, 0.8F).setUnlocalizedName("insert_esapi").setTextureName(RefStrings.MODID + ":insert_esapi");
		insert_xsapi = new ItemModInsert(500, 0.5F, 1F, 1F, 0.6F).setUnlocalizedName("insert_xsapi").setTextureName(RefStrings.MODID + ":insert_xsapi");
		...
		stick_dynamite = new ItemGrenade(8).setUnlocalizedName("stick_dynamite").setCreativeTab(MainRegistry.weaponTab).setTextureName(RefStrings.MODID + ":stick_dynamite");
		...
		stick_dynamite_base = new Item().setUnlocalizedName("stick_dynamite_base").setCreativeTab(MainRegistry.weaponTab).setTextureName(RefStrings.MODID + ":stick_dynamite_base");
	...
	public static void initializeItem2() {
		...
		schrabidium_sword = new ItemSwordAbility(25, 0, MainRegistry.tMatSchrab)
				.addHitAbility(new WeaponAbility.RadiationAbility(10F))
				.addHitAbility(new WeaponAbility.VampireAbility(1F))
		...
		meteorite_sword_hardened = new ItemSwordMeteorite(25F, 0, matMeteorite).setUnlocalizedName("meteorite_sword_hardened").setTextureName(RefStrings.MODID + ":meteorite_sword");
		meteorite_sword_alloyed = new ItemSwordMeteorite(25F, 0, matMeteorite).setUnlocalizedName("meteorite_sword_alloyed").setTextureName(RefStrings.MODID + ":meteorite_sword");
		meteorite_sword_machined = new ItemSwordMeteorite(25F, 0, matMeteorite).setUnlocalizedName("meteorite_sword_machined").setTextureName(RefStrings.MODID + ":meteorite_sword");
		meteorite_sword_treated = new ItemSwordMeteorite(25F, 0, matMeteorite).setUnlocalizedName("meteorite_sword_treated").setTextureName(RefStrings.MODID + ":meteorite_sword");
		...
		meteorite_sword_bred = new ItemSwordMeteorite(25F, 0, matMeteorite).setUnlocalizedName("meteorite_sword_bred").setTextureName(RefStrings.MODID + ":meteorite_sword");
		meteorite_sword_irradiated = new ItemSwordMeteorite(25F, 0, matMeteorite).setUnlocalizedName("meteorite_sword_irradiated").setTextureName(RefStrings.MODID + ":meteorite_sword");
		meteorite_sword_fused = new ItemSwordMeteorite(25F, 0, matMeteorite).setUnlocalizedName("meteorite_sword_fused").setTextureName(RefStrings.MODID + ":meteorite_sword");
		meteorite_sword_baleful = new ItemSwordMeteorite(25F, 0, matMeteorite).setUnlocalizedName("meteorite_sword_baleful").setTextureName(RefStrings.MODID + ":meteorite_sword");
	...
	private static void registerItem() {
		...
		GameRegistry.registerItem(stick_dynamite_base, stick_dynamite_base.getUnlocalizedName()); //heave-ho!
