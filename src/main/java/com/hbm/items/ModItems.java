...
public class ModItems {
	...
	public static Item powder_hematite;
	public static Item powder_malachite;
	public static Item powder_galena;
	public static Item powder_wolframite;
	public static Item iron_tailings;
	public static Item copper_tailings;
	public static Item lead_tailings;
	public static Item tungsten_tailings;
	...
	{			
		...
		bundle_iron = new Item().setUnlocalizedName("bundle_iron").setCreativeTab(MainRegistry.partsTab).setTextureName(RefStrings.MODID + ":bundle_iron");
		...
		powder_hematite = new ItemCustomLore().setUnlocalizedName("powder_hematite").setCreativeTab(MainRegistry.partsTab).setTextureName(RefStrings.MODID + ":powder_hematite");
		powder_malachite = new ItemCustomLore().setUnlocalizedName("powder_malachite").setCreativeTab(MainRegistry.partsTab).setTextureName(RefStrings.MODID + ":powder_malachite");
		powder_galena = new ItemCustomLore().setUnlocalizedName("powder_galena").setCreativeTab(MainRegistry.partsTab).setTextureName(RefStrings.MODID + ":powder_galena");
		powder_wolframite = new ItemCustomLore().setUnlocalizedName("powder_wolframite").setCreativeTab(MainRegistry.partsTab).setTextureName(RefStrings.MODID + ":powder_wolframite");
		iron_tailings = new ItemCustomLore().setUnlocalizedName("iron_tailings").setCreativeTab(MainRegistry.partsTab).setTextureName(RefStrings.MODID + ":iron_tailings");
		lead_tailings = new ItemCustomLore().setUnlocalizedName("lead_tailings").setCreativeTab(MainRegistry.partsTab).setTextureName(RefStrings.MODID + ":lead_tailings");
		copper_tailings = new ItemCustomLore().setUnlocalizedName("copper_tailings").setCreativeTab(MainRegistry.partsTab).setTextureName(RefStrings.MODID + ":copper_tailings");
		tungsten_tailings = new ItemCustomLore().setUnlocalizedName("tungsten_tailings").setCreativeTab(MainRegistry.partsTab).setTextureName(RefStrings.MODID + ":tungsten_tailings");
		...
		gun_m2 = new  ItemGunBase(Gun50BMGFactory.getM2Config()).setFull3D().setUnlocalizedName("gun_m2").setCreativeTab(MainRegistry.weaponTab).setTextureName(RefStrings.MODID + ":gun_darter");//marker
		...
		bismuth_helmet = new ArmorBismuth(MainRegistry.aMatBismuth, 0, RefStrings.MODID + ":textures/armor/starmetal_1.png").setMod(0.45F)
		...
		bismuth_legs = new ArmorBismuth(MainRegistry.aMatBismuth, 2, RefStrings.MODID + ":textures/armor/starmetal_1.png").cloneStats((ArmorFSB) bismuth_helmet).setMod(0.45F).setUnlocalizedName("bismuth_legs").setTextureName(RefStrings.MODID + ":bismuth_legs");
		bismuth_boots = new ArmorBismuth(MainRegistry.aMatBismuth, 3, RefStrings.MODID + ":textures/armor/starmetal_1.png").cloneStats((ArmorFSB) bismuth_helmet).setMod(0.45F).setUnlocalizedName("bismuth_boots").setTextureName(RefStrings.MODID + ":bismuth_boots");
		...
		steel_helmet = new ArmorFSB(MainRegistry.aMatSteel, 0, RefStrings.MODID + ":textures/armor/steel_1.png").setMod(0.8F).setBlastProtection(0.75F).setUnlocalizedName("steel_helmet").setTextureName(RefStrings.MODID + ":steel_helmet");
		...
		paa_plate = new ArmorFSB(MainRegistry.aMatPaa, 1, RefStrings.MODID + ":textures/armor/paa_1.png").setCap(10F).setThreshold(6).setMod(0.5F).setNoHelmet(true)
		...
		asbestos_helmet = new ArmorFSB(MainRegistry.aMatAsbestos, 0, RefStrings.MODID + ":textures/armor/asbestos_1.png").setMod(0.6F).setThreshold(7).setFireproof(true).setOverlay(RefStrings.MODID + ":textures/misc/overlay_asbestos.png").setUnlocalizedName("asbestos_helmet").setTextureName(RefStrings.MODID + ":asbestos_helmet");
		...
		security_helmet = new ArmorFSB(MainRegistry.aMatSecurity, 0, RefStrings.MODID + ":textures/armor/security_1.png").setMod(0.7F).setUnlocalizedName("security_helmet").setTextureName(RefStrings.MODID + ":security_helmet");
		...
		cobalt_helmet = new ArmorFSB(MainRegistry.aMatCobalt, 0, RefStrings.MODID + ":textures/armor/cobalt_1.png").setMod(0.5F).setUnlocalizedName("cobalt_helmet").setTextureName(RefStrings.MODID + ":cobalt_helmet");
	...
	public static void initializeItem2() {
		...
		t45_helmet = new ArmorT45(aMatT45, 0, 2500000, 1, 20, 5).setCap(10F).setMod(0.4F).setThreshold(14)
				.setFireproof(true)
				.enableVATS(true)
		...
		t45_plate = new ArmorT45(aMatT45, 1, 2500000, 1, 20, 5).cloneStats((ArmorFSB) t45_helmet).setUnlocalizedName("t45_plate").setMaxStackSize(1).setTextureName(RefStrings.MODID + ":t45_plate");
		t45_legs = new ArmorT45(aMatT45, 2, 2500000, 1, 20, 5).cloneStats((ArmorFSB) t45_helmet).setUnlocalizedName("t45_legs").setMaxStackSize(1).setTextureName(RefStrings.MODID + ":t45_legs");
		t45_boots = new ArmorT45(aMatT45, 3, 2500000, 1, 20, 5).cloneStats((ArmorFSB) t45_helmet).setUnlocalizedName("t45_boots").setMaxStackSize(1).setTextureName(RefStrings.MODID + ":t45_boots");
		...
		steamsuit_helmet = new ArmorDesh(aMatDesh, 0, RefStrings.MODID + ":textures/armor/starmetal_1.png", Fluids.STEAM, 64_000, 500, 50, 1).setThreshold(8F).setMod(0.5F)
				.setFireproof(true)
				.setHasHardLanding(true)
		...
		ajro_helmet = new ArmorAJRO(aMatAJR, 0, RefStrings.MODID + ":textures/armor/starmetal_1.png", 2500000, 10000, 2000, 25).setMod(0.3F).setCap(10.0F).setThreshold(14F)
				.setFireproof(true)
				.enableVATS(true)
				.setHasGeigerSound(true)
				.setHasHardLanding(true)
		...
		bj_helmet = new ArmorBJ(aMatBJ, 0, RefStrings.MODID + ":textures/armor/starmetal_1.png", 10000000, 10000, 1000, 100).setMod(0.4F).setCap(10.0F).setThreshold(10F)
				.setFireproof(true)
				.enableVATS(true)
				.enableThermalSight(true)
				.setHasGeigerSound(true)
		...
		envsuit_helmet = new ArmorEnvsuit(aMatEnv, 0, RefStrings.MODID + ":textures/armor/starmetal_1.png", 100_000, 1_000, 250, 0).setMod(0.5F).setThreshold(5.0F)
		...
		hev_helmet = new ArmorHEV(aMatHEV, 0, RefStrings.MODID + ":textures/armor/starmetal_1.png", 1000000, 10000, 2500, 0).setMod(0.5F).setCap(10.0F).setThreshold(9.0F)
				.addEffect(new PotionEffect(Potion.moveSpeed.id, 20, 0))
				.addEffect(new PotionEffect(Potion.jump.id, 20, 0))
		...
		fau_helmet = new ArmorDigamma(aMatFau, 0, RefStrings.MODID + ":textures/armor/starmetal_1.png", 10000000, 10000, 2500, 0).setMod(0.08F).setCap(4.0F).setThreshold(20.0F)
				.addEffect(new PotionEffect(Potion.jump.id, 20, 1))
		...
		trenchmaster_helmet = new ArmorTrenchmaster(aMatTrench, 0, RefStrings.MODID + ":textures/armor/starmetal_1.png").setMod(0.3F).setThreshold(9.0F).setCap(5)
				.addEffect(new PotionEffect(Potion.damageBoost.id, 20, 2))
		...
		titanium_sword = new ItemSwordAbility(25F, 0, MainRegistry.tMatTitan).setUnlocalizedName("titanium_sword").setTextureName(RefStrings.MODID + ":titanium_sword");
		...
		dwarven_pickaxe = new ItemToolAbility(5F, -0.1, matDwarf, EnumToolType.MINER)//marker
	...
	private static void registerItem() {
		...
		GameRegistry.registerItem(powder_hematite, powder_hematite.getUnlocalizedName());
		GameRegistry.registerItem(powder_malachite, powder_malachite.getUnlocalizedName());
		GameRegistry.registerItem(powder_galena, powder_galena.getUnlocalizedName());
		GameRegistry.registerItem(powder_wolframite, powder_wolframite.getUnlocalizedName());
		GameRegistry.registerItem(iron_tailings, iron_tailings.getUnlocalizedName());
		GameRegistry.registerItem(lead_tailings, lead_tailings.getUnlocalizedName());
		GameRegistry.registerItem(copper_tailings, copper_tailings.getUnlocalizedName());
		GameRegistry.registerItem(tungsten_tailings, tungsten_tailings.getUnlocalizedName());
		...
		GameRegistry.registerItem(bundle_iron, bundle_iron.getUnlocalizedName());
