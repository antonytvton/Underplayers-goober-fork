...
public class WeaponRecipes {
	...
	public static void register() {
		...
		CraftingManager.addRecipeAuto(ModItems.ammo_rocket.stackFromEnum(AmmoRocket.HE), new Object[] { "BAB", "ARA", "BAB", 'B', ModItems.ball_tatb, 'R', ModItems.ammo_rocket, 'A', ModItems.stick_c4 });
		...
		//Artillery Shells
		CraftingManager.addShapelessAuto(new ItemStack(ModItems.ammo_arty, 1, ItemAmmoArty.NUKE), new Object[] { new ItemStack(ModItems.ammo_arty, 1, ItemAmmoArty.NONE), ModItems.boy_bullet, ModItems.boy_target, ModItems.boy_shielding, DictFrame.fromOne(ModItems.circuit, EnumCircuitType.CONTROLLER), ModItems.ducttape });
		...
		//Grenades
		CraftingManager.addRecipeAuto(new ItemStack(ModItems.grenade_mk2, 2), new Object[] { " G ", "SGS", " S ", 'G', ModItems.plate_iron, 'S', Items.gunpowder });
		//Sticks of explosives
		CraftingManager.addRecipeAuto(new ItemStack(ModItems.stick_dynamite_base, 4), new Object[] { " S ", "PDP", "PDP", 'S', ModItems.safety_fuse, 'P', Items.paper, 'D', ModItems.ball_dynamite });
		CraftingManager.addRecipeAuto(new ItemStack(ModItems.stick_dynamite, 1), new Object[] { "DDD", "DFD", "DDD", 'D', ModItems.stick_dynamite_base, 'F', ModItems.safety_fuse });
