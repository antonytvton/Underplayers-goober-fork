...
public class WorldConfig {
	...
	public static int bedrockIronSpawn = 300;
	public static int bedrockCopperSpawn = 300;
	public static int bedrockBoraxSpawn = 50;
	public static int bedrockChlorocalciteSpawn = 50;
	...
	public static int bedrockTitaniumSpawn = 150;
	public static int bedrockTungstenSpawn = 150;
	public static int bedrockGoldSpawn = 50;
	public static int bedrockUraniumSpawn = 100;
	public static int bedrockThoriumSpawn = 100;
	public static int bedrockCoalSpawn = 300;
	public static int bedrockNiterSpawn = 50;
	public static int bedrockFluoriteSpawn = 50;
	public static int bedrockRedstoneSpawn = 50;
	public static int bedrockRareEarthSpawn = 200;
