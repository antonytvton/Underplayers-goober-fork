...
public class HbmCollection {
	...
	public static final Set<AmmoItemTrait> MultiType = ImmutableSet.of(AmmoItemTrait.PRO_DAMAGE, AmmoItemTrait.NEU_HEAVY_METAL, AmmoItemTrait.CON_HEAVY_WEAR, AmmoItemTrait.PRO_PENETRATION, AmmoItemTrait.PRO_EXPLOSIVE, AmmoItemTrait.PRO_PHOSPHORUS_SPLASH);
